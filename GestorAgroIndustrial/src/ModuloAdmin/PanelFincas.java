...
public class PanelFincas extends javax.swing.JPanel {
    ...
    public void miFinca() {
        ...
        String ConsultaIndividual = ejemplo.consumoGET("http://localhost/ApiPhp-AgroGestor/cultivos/GetMyFinca.php", getData);
        if (!ConsultaIndividual.equals("[]")) {
            ...
            ImageIcon img = new ImageIcon(getClass().getResource("/img/Fincajj_1.jpg"));
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(img, javax.swing.GroupLayout.PREFERRED_SIZE, 346, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(97, 97, 97))
        );
