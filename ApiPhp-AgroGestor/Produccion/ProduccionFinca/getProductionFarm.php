<?php 
    ...
    if (!empty($_POST['id'])) {
        ...
        WHERE insumos_x_cultivos.id_finca = cultivos_finca.id_finca AND fincas.id_finca = $id AND produccion_cultivos.total != 0");
        $data = $list->fetchAll();
